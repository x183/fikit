...
adminRouter.post("/uploadPost", uploadPost.single("postImage"), (req, res) => {
  ...
  if (!validateJSONPost(newPost))
    return res.status(400).send("Invalid post data format");
...
adminRouter.post("/removePost", (req, res) => {
  if (!isAdminKeyValid(req.body.adminKey))
    return res.status(403).send("Adminkey not valid");
...
adminRouter.post("/addPerson", (req, res) => {
  if (!isAdminKeyValid(req.body.adminKey))
    return res.status(403).send("Adminkey not valid");
...
adminRouter.post("/deletePerson", (req, res) => {
  if (!isAdminKeyValid(req.body.adminKey))
    return res.status(403).send("Adminkey not valid");
...
adminRouter.post("/updatePerson", (req, res) => {
...
adminRouter.post("/addYear", (req, res) => {
  if (!isAdminKeyValid(req.body.adminKey))
    return res.status(403).send("Adminkey not valid");
...
adminRouter.post("/deleteYear", (req, res) => {
  if (!isAdminKeyValid(req.body.adminKey))
    return res.status(403).send("Adminkey not valid");
...
adminRouter.post("/updateYear", (req, res) => {
  if (!isAdminKeyValid(req.body.adminKey))
    return res.status(403).send("Adminkey not valid");
